    ...
    public class EmployeeFactory : IEmployeeFactory
    {
        ...
        public EmployeeModel PrepareEmployeeViewModel(Employee employee, bool isMobileManage = false)
        {
            var emp = new EmployeeModel
            {
                ...
                CreatedDate = employee.CreatedDate.ConvertToUserTime().ToString("dd/MM/yyyy @ hh:mm tt"),
                CID = employee.CID,
                UserName = employee.UserName,
                IsQrVerify = employee.IsQrVerify,
                MobRegistrationDate = employee.MobRegistrationDate == null ? string.Empty : employee.MobRegistrationDate?.ConvertToUserTime().ToString("dd/MM/yyyy"),
